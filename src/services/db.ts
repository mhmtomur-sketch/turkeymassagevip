...
export const ALL_INITIAL_PROFILES: Profile[] = [
  // 1-6 DIAMOND VIP
  {
    ...
    bio: 'İzmir Konak kendi lüks ve hijyenik yerimde medikal, aromaterapi, tantra ve klasik relax masaj hizmeti sunuyorum.',
  ...
  },
  {
    ...
    bio: 'Konak lüks rezidansta hijyenik, duşlu ve jakuzili ortamda unutulmaz terapi deneyimi.',
  ...
  },
  {
    ...
    bio: 'Konak bölgesinde profesyonel medikal, rahatlatıcı ve sıcak yağ terapi seansları.',
    services: ['Medikal Masaj', 'Relax Masaj', 'Sıcak Yağ Terapisi', 'Aromaterapi'],
    isAvailable: true,
    isVerified: true,
    isPublished: true,
    rating: 5.0,
  ...
  },
  {
    id: 'dm-5',
    name: 'MASÖZ HAZAL',
    slug: 'masoz-hazal-izmir',
    title: 'VIP Klasik & Aromaterapi Masöz',
    category: 'masoz',
    categoryName: 'Bireysel Masöz',
    city: 'İzmir',
    citySlug: 'izmir',
    ...
    phone: '05403225555',
    whatsapp: '05403225555',
    coverPhoto: 'https://images.unsplash.com/photo-1494790108377-be9c29b29330?auto=format&fit=crop&w=600&q=80',
    photos: [
      'https://images.unsplash.com/photo-1494790108377-be9c29b29330?auto=format&fit=crop&w=600&q=80'
    ],
    bio: 'İzmir Konak kendi özel stüdyomda VIP standartta masaj hizmeti.',
    services: ['Klasik Masaj', 'Aromaterapi', 'Relax Masaj'],
    isAvailable: true,
    isVerified: true,
    isPublished: true,
    rating: 5.0,
